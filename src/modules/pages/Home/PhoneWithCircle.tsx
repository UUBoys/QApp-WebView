...
const PhoneWithCircle = () => {
  return (
    <div className="hidden h-full  w-full items-center rounded-full  bg-primary md:flex  md:h-[70%] md:w-[70%] lg:absolute lg:bottom-[-100px] lg:right-[-100px] lg:h-[700px] lg:w-[700px] xl:bottom-[-145px] xl:right-[-175px] xl:h-[900px] xl:w-[900px]">
      <Image
