...
const ClubCard = ({
  ...
  return (
    <div
      ...
      className="mx-auto flex  w-2/3 min-w-[350px] cursor-pointer flex-row  flex-wrap rounded-lg bg-gray-700 antialiased shadow-lg transition-all hover:shadow-xl"
    >
      <div className="w-full md:w-1/3">
        <Image
          ...
          height={200}
          alt="image"
          className="antialiased shadow-lg"
          src={
            profileImage !== ""
              ? profileImage
      ...
      <div className="flex w-full flex-row flex-wrap p-3 md:w-2/3">
