...
const NavBar = () => {
  ...
  return (
    <div className="fixed inset-0 mx-auto mt-10 max-h-20 w-11/12 rounded-[20px] border border-gray-200 bg-white p-4 shadow-xl">
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center">
          ...
          <input
            className="ml-4 rounded-full border-2 border-gray-300 px-4 py-2 outline-none focus:border-blue-500"
            placeholder="zaregistrovat klub"
          />
        </div>
        <div className="flex items-center space-x-4">
          ...
          <button className="text-gray-600 transition-colors hover:text-blue-600">
            {/* Icon1 - replace with your icon component */}
          </button>
