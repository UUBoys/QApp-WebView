...
const HelpButton = () => {
  ...
  return (
    <>
      <div className="fixed bottom-[60px] right-[20px] z-[50]">
        {isOpen && (
      ...
      <div
        className="fixed bottom-[20px] right-[20px] z-20 flex max-w-[60px] rounded-full bg-primary p-[15px] shadow-2xl transition-all"
        onClick={() => setIsOpen((prev) => !prev)}
      >
        {isOpen ? (
